...
module.exports.fragments_reactKupToHtml = function(fragments_react, fragments_reactDomServer) {
  return function(f) {
    return fragments_reactDomServer.renderToStaticMarkup(fragments_react.kup(f));
  };
};

module.exports.fragments_reactToHtml = function(fragments_react, fragments_reactDomServer) {
  return function() {
    ...
    return fragments_reactDomServer.renderToStaticMarkup(element);
  };
};
